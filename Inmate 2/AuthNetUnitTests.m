...
#define API_LOGIN_ID @"8Zg92zM9"
#define TRANSACTION_KEY @"8Rbz299A5HBXEq95"

#define USERNAME @"1Life2Live"
#define PASSWORD @"100%Certified"
...
- (void) testLiveAuthNetAuthorize
{
	...
	///////////////
	request.transactionRequest.amount = @"1.23";
	AuthNet *an = [[AuthNet alloc] initWithAPILoginID:@"8Zg92zM9" andTransactionKey:@"8Rbz299A5HBXEq95" forEnvironment:ENV_LIVE];
	an.duplicateWindowValue = 1;
