...
+(void)showAlertForProcess{
	...
	av=[[UIAlertView alloc] initWithTitle:@"Please wait while we proceed your transaction...." message:nil delegate:self cancelButtonTitle:nil otherButtonTitles:nil]; 
