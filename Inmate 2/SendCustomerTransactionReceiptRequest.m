...
+ (SendCustomerTransactionReceiptRequest *) sendCustomerTransactionReceiptRequest {
    SendCustomerTransactionReceiptRequest *s = [[[SendCustomerTransactionReceiptRequest alloc] init] autorelease];
    return s;
}
...
- (NSString *) stringOfXMLRequest {
    ...
    NSString *s = [NSString stringWithFormat:@""
                   ...
                   ([ts length] ? [NSString stringWithFormat:@"<emailSettings>%@</emailSettings>", ts] : @"")];
	return s;
}
